$(document).ready(function () {
    ...
    var tocFlip = function(){
        if (getCookie('ciNav') == 'yes') {
            ...
            $('.wy-nav-categories-wrap').css({ background: 'none', 'margin-left': 0 });
            ...
            $('.wy-nav-categories-wrap').css({ background: 'none repeat scroll 0 0 #fcfcfc;', 'margin-left': '300px' });
            $('.wy-nav-side').show();
        }
    };
    if (getCookie('ciNav') == 'yes')
...
$(window).on('resize', function(){
    ...
    // change margin
        ...
        $('.wy-nav-categories-wrap').css({'margin-left': 0});
    }
    ...
    // change margin
        ...
        $('.wy-nav-categories-wrap').css({'margin-left': '300px'});
    }
});
